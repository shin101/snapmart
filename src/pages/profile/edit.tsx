...
const EditProfile = () => {
  return (
    <div className="py-10 px-4 space-y-4">
      ...
      <button className="mt-5 w-full bg-purple-500 hover:bg-purple-600 text-white py-2 px-4 border border-transparent rounded-md shadow-sm font-medium focus:ring-2 focus:ring-offset-2 focus:ring-purple-500 focus-outline-none">
        Update Profile
      </button>
    </div>
  );

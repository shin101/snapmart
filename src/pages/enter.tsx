      ...
      <div className="mt-16">
          ...
          <>
            ...
            <div className="flex flex-col items-center">
              ...
              <div className="grid  border-b w-full mt-8 grid-cols-2  bg-gray-50 ">
                <button
                  className={cls(
                    "pb-4 font-medium border-b-2 pt-4",
                    method === "email"
        ...
        <div className="mt-8">
          ...
          <div className="grid grid-cols-2 mt-6 gap-3">
            <button className="flex justify-center items-center py-2 px-4 border border-gray-300 rounded-md shadow bg-white font-medium text-gray-500 hover:bg-gray-50">
              <svg
                className="w-5 h-5"
                aria-hidden="true"
                fill="currentColor"
